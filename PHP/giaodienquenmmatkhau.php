		...
		<div class="row">	
			<div class="col-md-6">
				<section class="section-register">
					...
					<form class="register-form cf-style-1" id="register" method="POST" name="register" action="quenmatkhau.php">
                        	<div class="field-row">
                            <label>Email</label>
                            <input type="email" class="le-input" id="email1" name="email1" value=""/>
                        </div><!-- /.field-row -->
                        <div class="field-row">
                            <label>Mã Pin</label>
                            <input type="password" class="le-input" id="pin" name="pin" value=""/>
                        </div><!-- /.field-row -->
                        <div class="field-row">
                            <label>Mật khẩu mới</label>
                            <input type="password" class="le-input" id="password2" name="password2" value=""/>
                        </div><!-- /.field-row -->
                        <div class="field-row">
                            <label>Nhập lại mật khẩu mới</label>
                            <input type="password" class="le-input" id="cfpass1" name="cfpass1" value="" />
                        </div><!-- /.field-row -->              
                        <div class="buttons-holder">
                            <button type="submit" class="button button1" id="submit" name="btn_submit">Xác Nhận</button>
                        </div><!-- /.buttons-holder -->
					</form>
				</section>
			</div>
