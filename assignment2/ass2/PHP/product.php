 		...
 		<div class="oo-content">
	 		...
	 		<!-- ========================================= CONTENT BAR ========================================= -->
 					...
 					<div class="col-xs-12 col-md-9 padding-content col-sm-9 col-lg-9">
						<div class="oo-recommended">
								
								
									<div class="title-nav">
										<h2 class="h1">Đề xuất sản phẩm</h2>
									...
									<?php
										...
										$results = $mysqli_conn->query("SELECT type_id, productcode, productname, productimage, best, new, hot, salerate, normalprice FROM product WHERE product.new=1 AND product.hot=1");
										if (!$results){
											printf("Error: %s\n", $mysqli_conn->error);
											exit;
										}
										...
										while ($row = $results->fetch_assoc()) {
											...
											$new_product_list .= <<<EOT
												...
												<button type='submit' id='add-to-cart' class='add-to-cart' style='padding: 0px 32%'>Mua</button>
												<figcaption>
