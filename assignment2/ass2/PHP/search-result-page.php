 		...
 		<div class="oo-content">
							    ...
							    <div class="menu-list">
							        ...
							        <ul id="menu-content" class="menu-content collapse out">
								        ...
								        <li  data-toggle="collapse" data-target="#dogiadung" class="collapsed active">
							                <a href="#"><i class="fa fa-plug fa-lg"></i>Đồ gia dụng<span class="arrow"></span></a>
							            </li>
							            <li>
								        ...
								        <li  data-toggle="collapse" data-target="#beautiful" class="collapsed active">
							                <a href="#"><i class="fa fa-gift fa-lg"></i>Mỹ phẩm &amp; làm đẹp<span class="arrow"></span></a>
							            </li>
							            <li>
								        ...
								        <li  data-toggle="collapse" data-target="#health" class="collapsed active">
							                <a href="#"><i class="fa fa-heart fa-lg"></i>Sức khỏe<span class="arrow"></span></a>
							            </li>
							            <li>
								        ...
								        <li>
								            <a href="#"><i class="fa fa-bed fa-lg"></i> Nội thất</a>
								        </li>
	 		...
	 		<!-- ========================================= CONTENT BAR ========================================= -->
 					...
 					<div class="col-xs-12 col-md-9 padding-content col-sm-9 col-lg-9">
						...
						<?php
							if (isset($_GET["search-keyword"]) && isset($_GET["select-category"])){
								$keyword = $_GET["search-keyword"];
								$category= $_GET["select-category"];
								if ($category == 'Tất cả'){
									$results = $mysqli_conn->query("SELECT product.type_id AS type_id, product.productcode AS productcode, product.productname AS productname, product.productimage AS productimage, product.best AS best, product.new AS new, product.hot AS hot, product.salerate AS salerate, product.normalprice AS normalprice, category.category_id AS category_id, category.category_name AS category_name FROM product, category WHERE product.category_id = category.category_id AND product.productname LIKE '%$keyword%' ");
								}
								else {
									$results = $mysqli_conn->query("SELECT product.type_id AS type_id, product.productcode AS productcode, product.productname AS productname, product.productimage AS productimage, product.best AS best, product.new AS new, product.hot AS hot, product.salerate AS salerate, product.normalprice AS normalprice, category.category_id AS category_id, category.category_name AS category_name FROM product, category WHERE product.category_id = category.category_id AND product.productname LIKE '%$keyword%' AND category.category_name = '$category'");
								...
								echo "<h1>Đã tìm thấy $results->num_rows kết quả cho từ khóa '$keyword'</h1>";
				
								if ($results->num_rows > 0) {
									$search_product= "<div class='product-list'>
									...
									while ($row = $results->fetch_assoc()) {
										...
										$search_product .= "<div class='col-xs-6 col-md-4 margin-product-grid col-sm-4 col-lg-4'>
										<form class='form-item' style='overflow:hidden'>
											<figure class='product-card'>
											<div class='labels'>";
										if ($row["best"] == 1){
											$search_product .="<div class='ribbon green'><span>Best seller</span></div>";
										}
										if ($row["new"] == 1){
											$search_product .="<div class='ribbon blue'><span>New</span></div>";
										}
										if ($row["hot"] == 1){
											$search_product .="<div class='ribbon red'><span>Hot</span></div>";
										}
